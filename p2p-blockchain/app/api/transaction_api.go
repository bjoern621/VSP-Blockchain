...
import "s3b/vsp-blockchain/p2p-blockchain/app/core"

// TransactionAPI is the external API for creating transactions.
// This interface is exposed to the infrastructure layer (gRPC adapter).
type TransactionAPI interface {
	...
	CreateTransaction(recipientVSAddress string, amount uint64, senderPrivateKeyWIF string) core.TransactionResult
}
...
func (api *TransactionAPIImpl) CreateTransaction(recipientVSAddress string, amount uint64, senderPrivateKeyWIF string) core.TransactionResult {
