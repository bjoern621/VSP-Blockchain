...
func TestValidateTransaction_UTXONotFound(t *testing.T) {
	...
	brokenValidator := TransactionValidationService{UTXOService: brokenUTXO}
...
func TestValidateTransaction_PubKeyMismatch(t *testing.T) {
	...
	badValidator := TransactionValidationService{UTXOService: badUTXO}
...
func TestValidateTransaction_InvalidSignature(t *testing.T) {
	...
	validator := TransactionValidationService{UTXOService: mockUTXO}
