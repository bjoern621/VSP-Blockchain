...
// Address: 1E4vJBecrka7M9RBER5H2RTYzLrFbkjBhY
var sampleKeyset1 = common.Keyset{
	...
	VSAddress:     "1E4vJBecrka7M9RBER5H2RTYzLrFbkjBhY",
}
...
// Address: 14xv3Q3b8g2Zgw9unNivU8iCJQGzqftkPa
var sampleKeyset2 = common.Keyset{
	...
	VSAddress:     "14xv3Q3b8g2Zgw9unNivU8iCJQGzqftkPa",
}
...
func TestKeyGeneratorApiImpl_GetKeyset_odd(t *testing.T) {
	...
	if keyset.VSAddress != sampleKeyset2.VSAddress {
		t.Errorf("keyset.VSAddress does not match the given VSAddress")
	}
}
