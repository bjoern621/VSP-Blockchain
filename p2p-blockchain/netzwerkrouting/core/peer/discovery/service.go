...
func NewDiscoveryService(querier RegistryQuerier, peerCreator peer.PeerCreator, addrMsgSender AddrMsgSender, peerRetriever DiscoveryPeerRetriever) *DiscoveryService {
