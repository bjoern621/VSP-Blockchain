...
func NewServer(handshakeMsgHandler handshake.HandshakeMsgHandler, networkInfoRegistry *networkinfo.NetworkInfoRegistry, peerCreator peer.PeerCreator) *Server {
	return &Server{
